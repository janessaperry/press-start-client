...
const Footer = () => {
  ...
  return (
    <footer className="container px-4 py-8 text-grey-50 md:px-8 space-y-10">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-10">
        ...
        <div className="col-span-1 space-y-2">
          <p className="font-bold">Explore Games</p>
          <ul className="space-y-2">
            <li><Link to="/explore/nintendo" className="hover:text-interactive-primary-hover">Nintendo</Link></li>
            <li><Link to="/explore/playstation" className="hover:text-interactive-primary-hover">PlayStation</Link></li>
